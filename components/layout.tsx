...
const Layout: React.FC<Props> = ({ children, pageTitle }: Props) => {
  return (
    <div className="flex flex-col h-screen bg-white dark:bg-gray-800">
        <header className="flex w-full p-3 bg-teal-500 bg-green-500 dark:bg-green-500">
      ...
      <div className="bg-gray-800 bg-opacity-75">
        <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <p className="text-sm text-gray-400 sm:ml-6 sm:mt-0 mt-4">© 2021 {siteTitle} —
              <a href="https://twitter.com/knyttneve" className="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">@Kyohei</a>
            </p>
